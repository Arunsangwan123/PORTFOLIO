        ...
        <div id="home" className="w-full flex-grow flex flex-col justify-center min-h-[80vh] relative pt-10 md:pt-16">
            <div className="max-w-4xl relative z-10 mx-auto text-center md:text-left">
                ...
                >
                    ...
                    <span className="text-gradient drop-shadow-[0_0_30px_rgba(0,240,255,0.4)]">Arun Sangwan</span>
                </motion.h1>
                ...
                >
                    I am a 3rd-year Computer Science student at <strong className="text-gray-200 font-medium">Lovely Professional University</strong> passionate about building dynamic web applications using PHP, React, and MySQL.
                </motion.p>
